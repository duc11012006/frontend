...
axios.get(`${BASE_URL}categories_news/${id}/articles?offset=3&limit=4`).then((response) =>{
    const categories = response.data;
    let htmlMenu = '';
    categories.forEach(item => {
      ...
      htmlMenu += /* html */ `						<div class="col-md-6 mb-4">
							<article class="card article-card article-card-sm h-100">
								...
								<div class="card-body px-0 pb-0">
									...
									<h2><a class="post-title" href="article.html">${item.title}</a></h2>
          ...
          <article class="card mb-4">
                  ...
                  <div class="card-body px-0 pb-1">
                    <h3><a class="post-title post-title-sm"
                        href="article.html">${item.title}</a></h3>
                    <p class="card-text">${content}</p>
